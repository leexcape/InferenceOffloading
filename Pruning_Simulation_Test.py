from Pruning_Simulation import pruning_task
import pandas as pd
...
for pp in range(6):
    T_device, T_server, T_trans, E_device, E_server, E_trans, cost, acc, communication_payload = pruning_task(pp, 0.5)
...
dataframe.to_csv('./results/p_data.csv')
