from Vanilla_Simulation import vanilla_task
import pandas as pd
...
for pp in range(6):
    T_device, T_server, T_trans, E_device, E_server, E_trans, cost, acc, communication_payload = vanilla_task(pp)
...
dataframe.to_csv('./results/null_data.csv')
